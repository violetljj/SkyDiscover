...
from skydiscover.optimize.search.adaevolve.paradigm import ParadigmGenerator
    ...
    async def _execute_generation(
        ...
        try:
            ...
            if self.config.language == "image":
                from skydiscover.optimize.search.utils.discovery_utils import build_image_content
