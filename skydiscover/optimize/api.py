...
Quick-start::
    ...
    result = run_discovery(
        ...
        model="gpt-5",  # or "gemini/gemini-3-pro-preview", "anthropic/claude-sonnet-4-6", etc.
        iterations=50,
    )
...
from skydiscover.optimize.config import Config, apply_overrides, load_config
...
from skydiscover.optimize.utils.prepare import cleanup_temp, prepare_evaluator, prepare_program
...
def run_discovery(
    ...
    Args:
        ...
        model: Model name(s), comma-separated. e.g. "gpt-5" or "gemini/gemini-3-pro-preview".
        ...
        if search_type:
            ...
            if is_external(search_type):
                ...
                try:
                    ...
                    from skydiscover.optimize.extras.external import get_package_name
