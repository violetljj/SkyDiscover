#!/usr/bin/env python3
"""Common budgeted search and sealed adjudication harness for L10M-COMP-2."""
...
DEV_SCENARIO_ENV = "L10M_COMP2_DEV_SCENARIOS"
ARM_CONFIGS = {
    "naked_codex": HERE / "configs" / "naked_codex.yaml",
    "evox": HERE / "configs" / "evox.yaml",
    "sky_evox": HERE / "configs" / "sky_evox.yaml",
}
...
def _load_hidden_evaluator(hidden_path: Path):
    spec = importlib.util.spec_from_file_location(
        f"l10m_comp2_hidden_{time.time_ns()}", BASE_EVALUATOR
    )
