#!/usr/bin/env python3
"""Archive COMP-2 receipts and compute descriptive secondary endpoints.

This post-treatment closeout utility has no primary-claim authority. The
execution-manifest-bound ``analysis.py`` alone decides G1 and G2.
"""
...
def closeout(source_root: Path) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    audit = {
        ...
        "candidate_manifests_local_only": 72,
        ...
        "orchestration_events": [
            {
                "event": "DUPLICATE_PRE_RUN_REQUEST_REJECTED_CREATE_ONCE",
                "target": "instance_11/seed_733",
                "request_count": 3,
