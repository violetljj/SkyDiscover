...
FILES = [
    ...
    "benchmarks/blindassist_last10m_sky_1/mechanical_preflight.json",
    "benchmarks/blindassist_last10m_sky_1/provider_preflight.json",
    "benchmarks/blindassist_last10m_sky_1/provider_preflight.py",
